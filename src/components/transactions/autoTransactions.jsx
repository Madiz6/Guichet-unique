...
async function _ledger(transactionId, amount, date, libelle, type, sourceModule, pieceRef = "") {
  const PCG_RULES = {
    ...
    debt_payment_employee:  [{ account_code: "455", account_name: "Associés — comptes courants / Personnel", side: "debit" }, { account_code: "512", account_name: "Banques", side: "credit" }],
    debt_payment_bank:      [{ account_code: "164", account_name: "Emprunts auprès des établissements de crédit", side: "debit" }, { account_code: "512", account_name: "Banques", side: "credit" }],
    ...
    bank_fees:              [{ account_code: "627", account_name: "Services bancaires et assimilés", side: "debit" }, { account_code: "512", account_name: "Banques", side: "credit" }],
    employee_expense:       [{ account_code: "625", account_name: "Déplacements, missions et réceptions", side: "debit" }, { account_code: "455", account_name: "Associés — comptes courants / Personnel", side: "credit" }],
    capital_contribution:   [{ account_code: "512", account_name: "Banques", side: "debit" }, { account_code: "101", account_name: "Capital social", side: "credit" }],
    client_invoice:         [{ account_code: "411", account_name: "Clients", side: "debit" }, { account_code: "706", account_name: "Prestations de services", side: "credit" }],
    client_payment:         [{ account_code: "512", account_name: "Banques", side: "debit" }, { account_code: "411", account_name: "Clients", side: "credit" }],
    };
  const JOURNAL_MAP = {
    ...
    debt_payment_employee: "OD", debt_payment_bank: "BNQ",
    loan_repayment: "BNQ",
    lease_revenue: "VTE", lease_payment: "BNQ",
    expense: "OD", bank_fees: "BNQ",
    employee_expense: "OD", capital_contribution: "BNQ",
    client_invoice: "VTE", client_payment: "VTE",
  };
