...
const PCG_OPERATIONS = [
  { module: 'Achats & Fournisseurs', label: 'Facture fournisseur à payer', description: 'Facture reçue, non encore réglée', journal: 'ACH', debit: '6xxx Charges', credit: '401 Fournisseur', bookingType: 'Facture fournisseur', operationType: 'Dépense non payée' },
  ...
  { module: 'Clients & Ventes', label: 'Paiement client reçu', description: 'Règlement client encaissé en banque', journal: 'VTE', debit: '512 Banque', credit: '411 Clients', bookingType: 'Facture client', operationType: 'Paiement reçu client' },
  ...
  { module: 'Dettes centralisées', label: 'Dette partenaire', description: 'Dette contractuelle ou investissement à rembourser', journal: 'BNQ / OD', debit: 'Selon type', credit: '101 Capital / 512 Banque', bookingType: 'Dette partenaire', operationType: 'Dette partenaire' },
