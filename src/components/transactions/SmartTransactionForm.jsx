...
const COMPTABILISATION_TYPES = {
  ...
  'dette_fournisseur': {
    ...
    description: 'Enregistrer une dette fournisseur active',
    emoji: '🏭',
    journal: 'ACH',
    pcg_debit: '6xxx Charges',
    pcg_credit: '401 Fournisseur',
  ...
  'dette_partenaire': {
    module: 'Dettes centralisées',
    label: 'Dette partenaire / investisseur',
    description: 'Enregistrer une dette partenaire active',
    emoji: '🤝',
    journal: 'OD',
    pcg_debit: '6xxx Charges',
    pcg_credit: '101 Capital',
  ...
  'dette_employe': {
    module: 'Dettes centralisées',
    label: 'Dette employé',
    description: 'Salaires ou frais dus à un employé',
    emoji: '👤',
    journal: 'OD',
    pcg_debit: '641 Salaires',
    pcg_credit: '455 Employé',
  ...
  'dette_bancaire': {
    module: 'Dettes centralisées',
    label: 'Dette bancaire / emprunt',
    description: 'Enregistrer un emprunt ou dette bancaire',
    emoji: '🏦',
    journal: 'BNQ',
    pcg_debit: '512 Banque',
    pcg_credit: '164 Emprunt',
