/**
 * Supabase compat shim — replaces @base44/sdk
 * Exposes the same `base44` interface that existing pages/components use.
 */
import { supabase } from '@/lib/supabase'

// ── Table mapping (Base44 entity name → Supabase table) ─────────────────────
const TABLE_MAP = {
