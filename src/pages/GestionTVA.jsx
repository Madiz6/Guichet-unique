...
export default function GestionTVA() {
  ...
  // Calculate cumulative DECLARED TVA (sum of all declarations)
  const declaredTVATotal = useMemo(() => {
    return declarations.reduce((sum, decl) => sum + (decl.tva_finale || 0), 0);
  }, [declarations]);
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { label: 'TVA Déclarée (Cumulative)', value: tvaActive ? `${(declaredTVATotal / 1000).toFixed(0)}K DJF` : '0 DJF', sub: tvaActive ? '10% sur factures après seuil' : 'Seuil non atteint', color: tvaActive ? 'purple' : 'gray' },
